...
function One() {
  ...
  const logoTransforms = useInterpolate(['start + 1.7s', 'start + 2.2s'], {
    scale: [2, 1],
    translateX: [28, 0],
  }, {
    easing: Easing.inOut(Easing.ease),
  ...
  return (
    // 417x222
    <svg width="415" height="210" viewBox="0 0 415 210" fill="none" xmlns="http://www.w3.org/2000/svg" style={{
      transform: `scale(${logoTransforms.scale}) translateX(${logoTransforms.translateX}%)`,
    }}>
